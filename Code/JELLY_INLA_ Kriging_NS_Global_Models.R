...
N_ni_ns<- y ~ -1 + Intercept + sst + bt + mld + depth + chl + tdiff + sal

# No interactions model - spatial 
N_ni_s<- y ~ -1 + Intercept + sst + bt + mld + depth + chl + tdiff + sal + f(w, model = spde_b)

#Interactions - no spatial
N_i_ns<- y ~ -1 + Intercept + sst +  bt + mld + sal + depth + chl + tdiff + sst:bt + sst:sal + sst:mld + sst:depth + sst:chl + sst:tdiff + bt:sal + bt:mld + bt:depth +  bt:chl + bt:tdiff + sal:mld + sal:depth + sal:tdiff + mld:depth + mld:chl + mld:tdiff + depth:chl + depth:tdiff + chl:tdiff + chl:sal 

#Interactions - spatial
N_i_s<- y ~ -1 + Intercept + sst +  bt + mld + sal + depth + chl + tdiff + sst:bt + sst:sal + sst:mld + sst:depth + sst:chl + sst:tdiff + bt:sal + bt:mld + bt:depth +  bt:chl + bt:tdiff + sal:mld + sal:depth + sal:tdiff + mld:depth + mld:chl + mld:tdiff + depth:chl + depth:tdiff + chl:tdiff + chl:sal + f(w, model = spde_b)

N_ni_ns_m <- inla(N_i_s, 
                  family = "gaussian", 
...
# 3. 
# 3. No interactions model - no spatial 
C_ni_ns<- y ~ -1 + Intercept + sst + bt + mld + depth + chl + tdiff + sal

# No interactions model - spatial 
C_ni_s<- y ~ -1 + Intercept + sst + bt + mld + depth + chl + tdiff + sal + f(w, model = spde_b)

#Interactions - no spatial
C_i_ns<- y ~ -1 + Intercept + sst +  bt + mld + sal + depth + chl + tdiff + sst:bt + sst:sal + sst:mld + sst:depth + sst:chl + sst:tdiff + bt:sal + bt:mld + bt:depth +  bt:chl + bt:tdiff + sal:mld + sal:depth + sal:tdiff + mld:depth + mld:chl + mld:tdiff + depth:chl + depth:tdiff + chl:tdiff + chl:sal 

#Interactions - spatial
C_i_s<- y ~ -1 + Intercept + sst +  bt + mld + sal + depth + chl + tdiff + sst:bt + sst:sal + sst:mld + sst:depth + sst:chl + sst:tdiff + bt:sal + bt:mld + bt:depth +  bt:chl + bt:tdiff + sal:mld + sal:depth + sal:tdiff + mld:depth + mld:chl + mld:tdiff + depth:chl + depth:tdiff + chl:tdiff + chl:sal + f(w, model = spde_b)



c_ni_ns_m<- inla(C_i_s, 
               family = "gaussian", 
...
#3.a. model outputs: 
summary(c_ni_ns_m)
Fit1 <- c_ni_ns_m$summary.fitted.values$mean[1:57]
E1   <- Jelly$dN15 - Fit1
...
writeRaster(c_mean_raster, "c_mean_raster_C_ni_ns2_global",overwrite=TRUE)
writeRaster(c_var_raster, "c_var_raster_C_ni_ns2_global",overwrite=TRUE)
writeRaster(n_mean_raster, "n_mean_raster_N_ni_ns2_global",overwrite=TRUE)
writeRaster(n_var_raster, "n_var_raster_N_ni_ns2_global",overwrite=TRUE)

#to save in final code/thesis files:
